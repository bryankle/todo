...
// Collection of DOM elements and methods
	var references = {
...
// Initiate application
	var init = function() {
		// Collection of assigned event listeners
		var events = {
		...
		// Material UI drop down feature for item settings
	...
	// Collection of user executed functions
	var actions = {
